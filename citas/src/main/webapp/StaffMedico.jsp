...
<body>
  ...
  <div class="contenidopantalla">
    ...
    <div class="content-main">
      <div class="header">
        <span>Lista de Médicos - Staff CJP</span>
      </div>
      ...
      <div class="filtros-listado">
        ...
        <button class="btn-primary" onclick="window.location.href='UsuarioReservaCita.jsp'">
          <svg width="12" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24"><path d="M19 11H13V5a1 1 0 10-2 0v6H5a1 1 0 100 2h6v6a1 1 0 102 0v-6h6a1 1 0 100-2z"/></svg>
          Reservar cita
        </button>
      </div>
  ...
  <script src="js/obtenerMedicos.js"></script>
</body>
</html>
